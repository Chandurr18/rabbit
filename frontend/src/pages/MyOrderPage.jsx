...
const MyOrderPage = () => {
    ...
    setTimeout(() => {
      const mockOrders = [
        ...
        },
        {
          _id: 35456,
          createdAt: new Date(),
          shippingAddress: { city: "Telangana", country: "INDIA" },
          orderItems: [
            {
              name: "Product 2",
  ...
  return <div className="max-w-7xl mx-auto p-4 sm:p-6">
    ...
    <div className="relative shadow-md sm:rounded-lg overflow-x-auto scrollbar-hide [scrollbar-width:none]">
        <table className="min-w-full text-left text-gray-500 overflow-x-scroll">
