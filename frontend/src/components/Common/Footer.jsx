...
const Footer = () => {
  return (
    <footer className="border-t py-8 sm:py-12 px-3 sm:px-10">
        ...
        <div>
          ...
          <form action="" className="flex">
            <input
              ...
              className="p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded focus:outline-none focus-within:ring-2 focus:ring-gray-500 transition-all"
              required
            />
            <button
              type="submit"
      ...
      {/* Footer Bottom for Copy Right Text */}
